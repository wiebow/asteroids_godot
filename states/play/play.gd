...
func _on_create_bullet(new_position: Vector2, new_degrees: float) -> void:
	var scene := preload("res://objects/playerbullet/PlayerBullet.tscn")
...
func _on_create_saucer_bullet(new_position: Vector2) -> void:
	var scene = load("res://objects/saucerbullet/SaucerBullet.tscn")
	var bullet = scene.instance()
...
func _on_game_over() -> void:
	...
	# has been reached.
	var scene = preload("res://states/gameover/gameover.tscn")
